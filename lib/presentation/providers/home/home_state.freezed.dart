...
class _$HomeStateImpl implements _HomeState {
  _$HomeStateImpl(
      {this.isLoading = true, final List<PhotoEntity> photos = const []})
      : _photos = photos;
  ...
  @override
  String toString() {
    return 'HomeState(isLoading: $isLoading, photos: $photos)';
  }
...
abstract class _HomeState implements HomeState {
  factory _HomeState({final bool isLoading, final List<PhotoEntity> photos}) =
      _$HomeStateImpl;
